                ...
                <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-screen-xl">
                    ...
                    >
                        ...
                        <p className="text-lg lg:text-xl text-white mb-4">
                            I Am Into <span className="text-blue-400">Creative Designer</span>
                        </p>
                        <motion.button
                            onClick={() => {
                                window.open("https://linktr.ee/viveksingh22");
                            }}
                        ...
                        >
                            <Social onClick={() => window.open("https://github.com/viveksingh-22")}>
                            ...
                            <Social onClick={() => window.open("https://www.linkedin.com/in/vivek-singh-597890298/")}>
                            ...
                            <Social onClick={() => window.open("https://twitter.com/vivek_sing53300")}>
                            ...
                            <Social onClick={() => window.open("https://www.instagram.com/thakur_vivek_singh_23/?hl=en")}>
                    ...
                    >
                        <div className="rounded-full overflow-hidden w-48 h-48 lg:w-80 lg:h-80 bg-gray-800 flex items-center justify-center ml-[10vw]">
                            <img src="logo.jpeg" alt="Profile" className="object-cover w-full h-full" />
                        </div>
                    </motion.div>
                </div>
            </div>
